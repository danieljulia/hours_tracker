...
export declare class Plot extends Component {
     ...
     */
    entityNearest(queryPoint: Point, bounds?: Bounds): Plots.IPlotEntity;
    protected _entityVisibleOnPlot(entity: Plots.IPlotEntity | Plots.ILightweightPlotEntity, chartBounds: Bounds): boolean;
